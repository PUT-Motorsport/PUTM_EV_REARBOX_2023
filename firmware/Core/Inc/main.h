...
#define ADC_CHANNEL_COOLANT_IN_PRESSURE 4
#define ADC_CHANNEL_COOLANT_OUT_PRESSURE 5
#define ADC_CHANNEL_COOLANT_IN_TEMPERATURE 2
#define ADC_CHANNEL_COOLANT_OUT_TEMPERATURE 3
